  ...
  return (
    <div className="doc-content">
      <div className="links-sidebar">
        ...
        <ul className="list-group">
          <li className="list-group-item">
            <a href="#helpers">Helpers coming soon</a>
          </li>
        </ul>
      </div>
...
.catch(err => console.error(err))
  ...
  "properties": {
    ...
    "url": "https://www.swapi.tech/api/planets/1/"
        ...
        <p id="helpers">
          There WERE a bunch of helper libraries available for consuming the
          Star Wars API in a native programming language. Be on the look out for
          more soon!
        </p>
      </div>
    </div>
